...
correlation from scatter plots are not well understood, however some
...
correlation in scatterplots, but rather to investigate whether
...
The aim of our study is not to investigate equation 1, rather the
potential for alternative designs to have effects on cognition. For
these reasons, and in order to facilitate comparison to previous work,
we utilize the same protocols here to produce the stimuli for our main
study. This includes the number of points (n = 128), the value of
\emph{b} (0.25), and the size scaling factor and opacity floor. For our
atypical scatterplot condition, we choose to use the previously
established manipulation that has demonstrated the most dramatic change
in participants' estimates of correlation: a combination of point
opacity and size adjustments \citep{strain_2024} (see the right pair of
plots in Figure~\ref{fig-previous-manipulations}).
...
relatedness, taking into account the emotional content of the statement
and the graph literacy and defensive confidence of participants.
...
present study is as follows; things that look more related are better
...
of the graph, the general consensus on how related the variables in
