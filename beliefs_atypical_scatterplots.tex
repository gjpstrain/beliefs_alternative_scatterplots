...
in \#sec-scatterplots, we make the following hypotheses:
...
\item
  ...
  relatedness before and after participants viewed scatterplots in
  either the standard or alternative conditions.
\item
...
participant's scores on a defensive confidence test, their scores on a
...
participant's estimates of positive correlation
...
and perceptual effects on performance in visualization tasks; this was
the primary intention behind performing the pre-study. Nonetheless, we
cannot be certain that each participant considers the emotional content
of our chosen correlative statement to be the same. To allow for these
