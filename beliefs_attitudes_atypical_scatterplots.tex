...
\tightlist
\item
  scatterplots are used for
\item
  scatterplots display/communicate
\item
  key issue: correlation is underestimated in scatterplots
\item
  this is problematic as normal people have to use them
\item
  responsibility of data viz designers etc
\item
  recent work has atttempted to address these issues
\item
...
present study, however, we do not conisder this a shortcoming.
