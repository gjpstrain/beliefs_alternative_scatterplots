...
scatterplots. The systematic change of the sizes and opacities of
scatterplot points can be used to bias estimates upwards and correct for
the underestimation, although this has only been demonstrated with
regards to a simple estimation paradigm. We present a fully-reproducible
study in which we demonstrate that the same techniques that can correct
for the underestimation bias can also be used to induce stronger levels
of belief change compared to typical scatterplots presenting identical
data. We show that novel visualization techniques can be utilized to
effect belief change, and suggest future directions for extending this
work with regards to changing people's attitudes and behaviours.    
\end{abstract}
