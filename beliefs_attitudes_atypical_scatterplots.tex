...
We find no effect of participant's scores on a Defensive Confidence test
(\(F\)(1) = 3.22, \emph{p} = .073). We find a significant effect of
participants' scores on a graph literacy test \citep{garcia_2016}
(\(F\)(1) = 15.78, \emph{p} \textless{} .001)
