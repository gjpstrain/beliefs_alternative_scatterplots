...
Statements}\label{pre-study-investigating-beliefs-about-relatedness-statements}
...
between the two raters, in order to penalise larger magnitude
disagreements more harshly. We found agreement above chance for both
topic emotionality (\(\kappa\) = 0.49, \emph{p} \textless{} .001) and
strength of correlation (\(\kappa\) = 0.51, \emph{p} \textless{} .001),
...
agreement, resulting in the 25 statements that can be seen in
Table~\ref{tbl-pre-test-hi} and Table~\ref{tbl-pre-test-low}.
...
being of low strength correlation.}
...
Scatterplots}\label{main-study-potential-for-belief-change-using-atypical-scatterplots}
