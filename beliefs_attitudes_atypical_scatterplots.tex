...
2024\citep{strain_2024}. Here, the size and opacity of a certain
scatterplot point is lowered as a function of that point's residual
...
creating scatterplots with 128 points, using a scaling factor and
constant for point size, and using an opacity floor to ensure point
visibility, as this has been an issue in previous work. As there is
evidence that people are less likely to update strongly held beliefs
following viewing scatterplot visualizations \citep[ look for
...
(46.7\% male, 52.0\% female, and 1.3\% non-binary). Participants' mean
age was 37.3 (\emph{SD} = 11.3). Participants' mean graph literacy score
was 22.1 (\emph{SD} = 3.9) out of 30. On average, participants took 15.1
minutes to complete the experiment (\emph{SD} = 7.70).
...
Again, we use PsychoPy \citep{pierce_2019} to build our experiment and
...
(version 1.1-35.3 \citep{lme4}) packages were used to build a linear
mixed effects model where participants' changes in belief strength were
predicted by the scatterplot condition they were assigned to.
