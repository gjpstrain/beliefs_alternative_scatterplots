...
%DIF DEL beliefs_alternative_scatterplots_pre_review.tex   Fri Nov 22 11:17:18 2024
%DIF ADD beliefs_alternative_scatterplots.tex              Tue Nov 26 12:06:53 2024
...
\acmConference[CHI]{}{June 03--05, 2018}{Woodstock, NY}
\acmPrice{15.00}
...
scatterplot points can bias estimates upwards, correcting \DIFdelbegin \DIFdel{this
underestimation in a simple estimation paradigm. Here}\DIFdelend \DIFaddbegin \DIFadd{for this
underestimation. Here, }\DIFaddend we examine whether application of these
...
that scatterplot manipulations that \DIFdelbegin \DIFdel{can }\DIFdelend \DIFaddbegin \DIFadd{are able to }\DIFaddend correct for the
correlation underestimation bias can also induce stronger levels of
belief change compared to \DIFdelbegin \DIFdel{unadapted }\DIFdelend \DIFaddbegin \DIFadd{conventional }\DIFaddend scatterplots presenting identical
...
%DIFDELCMD < \includegraphics[width=1\textwidth,height=\textheight]{beliefs_atypical_scatterplots_files/figure-pdf/fig-previous-manipulations-1.pdf}
%DIFDELCMD < 
...
for top-down effects to bias participants. \DIFaddbegin \DIFadd{Recent work has established
that scatterplots are able to induce different levels of belief change
in viewers \mbox{%DIFAUXCMD
\citep{karduni_2020, markant_2023}}\hskip0pt%DIFAUXCMD
; this may depend on
...
scatterplot design. }\DIFaddend Data visualization does not take place without
...
Framework (OSF) for the pre-study\footnote{\DIFdelbegin \DIFdel{removed for anon}\DIFdelend \DIFaddbegin \DIFadd{https://osf.io/xuf4d/?view\_only=f422aa2674164fad91d43a2b951a79e2}\DIFaddend }
and the main experiment\footnote{\DIFdelbegin \DIFdel{removed for anon}\DIFdelend \DIFaddbegin \DIFadd{https://osf.io/anmez/?view\_only=8745df2d0d9c4c81bfcca4d4fd41e6de}\DIFaddend }.
...
reproduces the computational environment \DIFaddbegin \DIFadd{in which }\DIFaddend the paper was written\DIFdelbegin \DIFdel{in}\DIFdelend .
...
collecting high-quality data. We use the Prolific \DIFdelbegin \DIFdel{.co }\DIFdelend platform
...
scatterplot design can alter participants' beliefs about \DIFdelbegin \DIFdel{the level of relatednessbetween variables}\DIFdelend \DIFaddbegin \DIFadd{correlations.
...
correlation for our participants as ``strength of relatedness''}\DIFaddend . There
...
control for these factors as much as possible \DIFaddbegin \DIFadd{in the main experiment}\DIFaddend , we
...
which they would have to \DIFdelbegin \DIFdel{indicate their beliefs about statement
emotionality and the strength of relatedness suggested using a pair of
sliders}\DIFdelend \DIFaddbegin \DIFadd{answer some questions}\DIFaddend . To familiarize
...
experiments increases, society becomes happier.'' \DIFdelbegin \DIFdel{The Likert scales used in the online experiment were }\DIFdelend \DIFaddbegin \DIFadd{Following each
...
}\DIFaddend identical to those \DIFdelbegin \DIFdel{described }\DIFdelend \DIFaddbegin \DIFadd{used by the researchers }\DIFaddend in
Section~\ref{sec-pre-study}.

\subsection{Results}\label{sec-results-pre}

All analyses were conducted using R (version 4.4\DIFdelbegin \DIFdel{.1 }\DIFdelend \DIFaddbegin \DIFadd{.2 }\DIFaddend \citep{rcore}). We
...
3 and 5 are statements 2, 10, 22, 16, and \DIFdelbegin \DIFdel{23. }\DIFdelend \DIFaddbegin \DIFadd{23, which can be seen in
Table~\ref{tbl-candidate-statements}. }\DIFaddend To ascertain which statements
...
\DIFdelbegin \DIFdel{correlation }\DIFdelend \DIFaddbegin \DIFadd{relatedness }\DIFaddend between the variables in question. We therefore test
...
\DIFdelbegin \DIFdel{atypical }\DIFdelend \DIFaddbegin \DIFadd{alternative }\DIFaddend scatterplot condition can affect estimates of correlation in
...
\caption{\label{tbl-candidate-statements}\DIFaddFL{Statements with neutral average
...
\DIFaddend \subsection{Discussion}\label{sec-discussion-pre}
...
would be expected by chance. \DIFdelbegin \DIFdel{We suggest this may be due to Fleiss' Kappa
not being designed with ordinal (Likert scales in this case) data in
mind. }\DIFdelend In light of this we do not make decisions
...
our \DIFdelbegin \DIFdel{analysis}\DIFdelend \DIFaddbegin \DIFadd{analyses}\DIFaddend .

\section{Main Study: Potential for Belief Change Using \DIFdelbegin \DIFdel{Atypical
}\DIFdelend \DIFaddbegin \DIFadd{Alternative
}\DIFaddend Scatterplots}\label{sec-main-study}

We test the statement that exhibited the lowest average level of belief
about \DIFdelbegin \DIFdel{correlation }\DIFdelend \DIFaddbegin \DIFadd{strength of relatedness }\DIFaddend and the 2nd highest level of consensus.
...
detecting an effect of viewing \DIFdelbegin \DIFdel{atypical }\DIFdelend \DIFaddbegin \DIFadd{alternative }\DIFaddend scatterplots, we elected to
...
of the experiment. \DIFdelbegin \DIFdel{We hypothesized that }\DIFdelend \DIFaddbegin \DIFadd{Based on previous evidence that beliefs can change
after viewing data visualisations \mbox{%DIFAUXCMD
\citep{karduni_2020, markant_2023}}\hskip0pt%DIFAUXCMD
,
...
estimates, we make the following hypotheses}\DIFaddend :

\DIFaddbegin \subsection{\DIFadd{Hypotheses}}\label{hypotheses}

\DIFaddend \begin{itemize}
\tightlist
\item
  H1: there will be a significant difference \DIFdelbegin \DIFdel{in }\DIFdelend \DIFaddbegin \DIFadd{between }\DIFaddend ratings of strength
  of relatedness \DIFaddbegin \DIFadd{made }\DIFaddend before and after participants viewed \DIFdelbegin \DIFdel{the experimental
  items}\DIFdelend \DIFaddbegin \DIFadd{scatterplots
  in either the standard or alternative conditions}\DIFaddend .
\item
  H2: this difference will be greatest when participants are exposed to
  scatterplots in the \DIFdelbegin \DIFdel{atypical }\DIFdelend \DIFaddbegin \DIFadd{alternative scatterplot }\DIFaddend condition.
\end{itemize}

\DIFaddbegin \DIFadd{We also undertake exploratory investigations taking into account
...
factors can be found in Section~\ref{sec-add-analyses}, and we justify
their inclusion below.
}

\DIFaddend \subsubsection{Defensive Confidence}\label{sec-def-con}
...
\DIFaddbegin \subsubsection{\DIFadd{Graph Literacy}}\label{sec-graph-lit}

\DIFadd{Previous work testing the systematic adjustment of point opacity and
size in scatterplots has found no effect of graph literacy on
participants' estimates of positive correlation
\mbox{%DIFAUXCMD
\citep{strain_2023, strain_2023b, strain_2024}}\hskip0pt%DIFAUXCMD
. Despite this, we elect
...
\mbox{%DIFAUXCMD
\citep{canham_2010, okan_2012}}\hskip0pt%DIFAUXCMD
. Additionally, the graph literacy test we
use \mbox{%DIFAUXCMD
\citep{garcia_2016} }\hskip0pt%DIFAUXCMD
is extremely short; in the present study, this
took participants an average of 27 seconds (}\emph{\DIFadd{SD}} \DIFadd{= 16 seconds).
}

\subsubsection{\DIFadd{Emotionality}}\label{sec-emotionality}

\DIFadd{As discussed in Section~\ref{sec-pre-study}, the emotional content of a
...
\mbox{%DIFAUXCMD
\citep{phelps_2006, harrison_2013, thoresen_2016}}\hskip0pt%DIFAUXCMD
...
\DIFaddend \subsection{Stimuli}\label{sec-stimuli-main}
...
that describe a strong relationship (0.6 \DIFdelbegin \DIFdel{\textgreater{} }\DIFdelend \DIFaddbegin \DIFadd{\textless{} }\DIFaddend \emph{r}
\DIFdelbegin \DIFdel{\textgreater{} }\DIFdelend \DIFaddbegin \DIFadd{\textless{} }\DIFaddend 0.99) to induce belief change. Our plots were created in
line with guidance provided by previous research\DIFdelbegin \DIFdel{and detailed in Section~\ref{sec-scatterplots}}\DIFdelend \DIFaddbegin \DIFadd{; plots in the
...
scatterplots \mbox{%DIFAUXCMD
\citep{strain_2023, strain_2023b, strain_2024}}\hskip0pt%DIFAUXCMD
}\DIFaddend . We used 45
...
\emph{r} value of 0.6 for both the \DIFdelbegin \DIFdel{typical and atypical }\DIFdelend \DIFaddbegin \DIFadd{standard and alternative }\DIFaddend scatterplot
...
%DIFDELCMD < \includegraphics[width=1\textwidth,height=\textheight]{beliefs_atypical_scatterplots_files/figure-pdf/fig-main-examples-1.pdf}
%DIFDELCMD < 
...
statements\DIFdelbegin \DIFdel{. They were, again, }\DIFdelend \DIFaddbegin \DIFadd{, after which they were }\DIFaddend asked to provide their age and gender
...
practice using the slider, before being asked to indicate their \DIFdelbegin \DIFdel{belief
}\DIFdelend \DIFaddbegin \DIFadd{beliefs
}\DIFaddend about emotionality and the \DIFdelbegin \DIFdel{relatedness between }\DIFdelend \DIFaddbegin \DIFadd{strength of relatedness between the }\DIFaddend variables
described in our chosen statement. We captured these data using Likert
scales identical to those described in Section~\ref{sec-pre-study}.
After completing the experimental trials, participants were tested again
on their beliefs about \DIFaddbegin \DIFadd{strength of }\DIFaddend relatedness and then debriefed that
the data they were shown were fictional. Interspersed among the
experimental items were 4 attention check trials which explicitly asked
participants to set the slider to 0 or 1.
...
%DIFDELCMD < \begin{tabular}[t]{lrrrlrr}
%DIFDELCMD < \toprule
%DIFDELCMD <   & Estimate & Standard Error & Z-value & \textit{p} & Odds Ratio & Cohen's \textit{d}\\
%DIFDELCMD < \midrule
%DIFDELCMD < Rating Time & 3.77 & 0.049 & 76.62 & <0.001 & 43.2 & 2.08\\
...
%DIFDELCMD < \includegraphics[width=1\textwidth,height=\textheight]{beliefs_atypical_scatterplots_files/figure-pdf/fig-descriptives-1.pdf}
%DIFDELCMD < 
...
\caption{\label{fig-descriptives}\DIFdelbeginFL \DIFdelFL{Boxplots showing ranges, interquartile
ranges, medians (vertical lines) and means }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Violin plots }\DIFaddendFL for \DIFdelbeginFL \DIFdelFL{participants' }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{pre- and post-plot
viewing }\DIFaddendFL ratings of strength of relatedness \DIFdelbeginFL \DIFdelFL{before }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{for standard }\DIFaddendFL and \DIFdelbeginFL \DIFdelFL{after viewing either typical or
atypical scatterplots}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{alternative
scatterplot conditions}\DIFaddendFL . \DIFaddbeginFL \DIFaddFL{Mean ratings are also shown as points.}\DIFaddendFL }
...
%DIFDELCMD < %%%
\DIFdelend Our second hypothesis, that the difference between ratings of strength
of relatedness before and after viewing experimental plots would be
greater when participants were assigned to the \DIFdelbegin \DIFdel{atypical }\DIFdelend \DIFaddbegin \DIFadd{alternative }\DIFaddend scatterplot
condition, also received support. \DIFdelbegin \DIFdel{Deviation }\DIFdelend \DIFaddbegin \DIFadd{Treatment }\DIFaddend coding was used for each of
the experimental factors of rating time (pre- or post-) and condition,
which allows us to compare means of ratings \DIFdelbegin \DIFdel{to the
grand mean}\DIFdelend \DIFaddbegin \DIFadd{made after viewing the
experimental items directly to those made before viewing}\DIFaddend . We built a
...
rating time as \DIFdelbegin \DIFdel{a predictor }\DIFdelend \DIFaddbegin \DIFadd{predictors }\DIFaddend explained significantly more variance than the
...
ratios and equivalent Cohen's \emph{d} \DIFaddbegin \DIFadd{effect sizes }\DIFaddend can be seen in
Table~\ref{tbl-condition-interact}. \DIFdelbegin \DIFdel{To further explore the interaction
,
we used the }\textbf{\DIFdel{emmeans}} %DIFAUXCMD
\DIFdel{package (version 1.10.4 \mbox{%DIFAUXCMD
\citep{emmeans}}\hskip0pt%DIFAUXCMD
) to calculate pairwise comparisons between levels of the condition and
...
between pre-viewing }\DIFdelend \DIFaddbegin \DIFadd{The estimate for the interaction
corresponds to the difference-in-difference between ratings made pre-
}\DIFaddend and post-viewing \DIFdelbegin \DIFdel{times for atypical as opposed to
typical plots}\DIFdelend \DIFaddbegin \DIFadd{for standard and alternative scatterplots}\DIFaddend .

\begin{table}

\caption{\label{tbl-condition-interact}Statistics for the significant
main effect of \DIFaddbeginFL \DIFaddFL{rating time and the significant interaction between
rating time and }\DIFaddendFL condition on the difference between pre- and post-
scatterplot viewing ratings for \DIFdelbeginFL \DIFdelFL{typical }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{standard }\DIFaddendFL and \DIFdelbeginFL \DIFdelFL{atypical }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{alternative }\DIFaddendFL plots. Odds
ratios and equivalent Cohen's \emph{d} \DIFaddbeginFL \DIFaddFL{effect sizes }\DIFaddendFL are also shown.\DIFdelbeginFL \DIFdelFL{NB: the odds ratio for
the effect of condition is caluclated based on the absolute value of the
estimate.}\DIFdelendFL }
...
%DIFDELCMD <   & Estimate & Standard Error & Z-value & \textit{p} & Odds Ratio & Cohen's \textit{d}\\
%DIFDELCMD < \midrule
%DIFDELCMD < Rating Time & 3.79 & 0.049 & 76.69 & <0.001 & 44.10 & 2.09\\
%DIFDELCMD < Condition & -0.13 & 0.390 & -0.33 & 0.745 & 1.14 & 0.07\\
%DIFDELCMD < Rating Time x Condition & 0.72 & 0.071 & 10.22 & <0.001 & 2.06 & 0.40\\
%DIFDELCMD < \bottomrule
%DIFDELCMD < \end{tabular}
%DIFDELCMD < 
...
%DIFDELCMD < \begin{tabular}[t]{lrl}
%DIFDELCMD < \toprule
%DIFDELCMD < Contrast & Z ratio & \textit{p}\\
%DIFDELCMD < \midrule
%DIFDELCMD < Post-Viewing x Atypical | Pre-Viewing x Atypical & 66.32 & <0.001\\
%DIFDELCMD < Post-Viewing x Atypical | Post-Viewing x Typical & 0.60 & 0.932\\
%DIFDELCMD < Post-Viewing x Atypical | Pre-Viewing x Typical & 9.32 & <0.001\\
%DIFDELCMD < Pre-Viewing x Atypical | Post-Viewing x Typical & -9.96 & <0.001\\
%DIFDELCMD < Pre-Viewing x Atypical | Pre-Viewing x Typical & -1.25 & 0.596\\
%DIFDELCMD < Post-Viewing x Typical | Pre-Viewing x Typical & 58.12 & <0.001\\
%DIFDELCMD < \bottomrule
%DIFDELCMD < \end{tabular}
%DIFDELCMD < 
...
participants who viewed scatterplots in the \DIFdelbegin \DIFdel{atypical }\DIFdelend \DIFaddbegin \DIFadd{alternative }\DIFaddend condition. These
...
specifically, participants' \DIFdelbegin \DIFdel{strength of beliefs about }\DIFdelend \DIFaddbegin \DIFadd{beliefs about strength of }\DIFaddend relatedness. These
...
%DIFDELCMD < \includegraphics{beliefs_atypical_scatterplots_files/figure-pdf/fig-add-analyses-plots-1.pdf}
%DIFDELCMD < 
...
emotionality (right). Localled smoothed \DIFdelbeginFL \DIFdelFL{cruves }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{curves with 95\% CI ribbons }\DIFaddendFL are
shown separately for \DIFdelbeginFL \DIFdelFL{typical }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{standard }\DIFaddendFL and \DIFdelbeginFL \DIFdelFL{atypical }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{alternative }\DIFaddendFL scatterplot viewing
...
Mean differences in pre- and post- \DIFdelbegin \DIFdel{plot-viewing }\DIFdelend \DIFaddbegin \DIFadd{plot viewing }\DIFaddend ratings of strength of
relatedness by Subjective Graph Literacy score can be seen in
Figure~\ref{fig-add-analyses-plots}. Generally, participants \DIFdelbegin \DIFdel{who scored
higher
}\DIFdelend \DIFaddbegin \DIFadd{with higher
scores }\DIFaddend on a graph literacy test experienced smaller changes in their
...
Generally, participants \DIFdelbegin \DIFdel{who scored more highly }\DIFdelend \DIFaddbegin \DIFadd{with higher scores }\DIFaddend on the defensive confidence
...
condition is novel\DIFdelbegin \DIFdel{(see Figure~\ref{fig-add-analyses-plots})}\DIFdelend . It would appear that despite following the normal
pattern of results for low to moderate levels of defensive confidence,
those participants who viewed the \DIFdelbegin \DIFdel{typical }\DIFdelend \DIFaddbegin \DIFadd{standard }\DIFaddend scatterplots experienced a
...
\DIFdelbegin \DIFdel{atypical }\DIFdelend \DIFaddbegin \DIFadd{alternative }\DIFaddend scatterplots was protective against an unexpected \DIFdelbegin \DIFdel{, standard }\DIFdelend behaviour
...
\DIFaddbegin \DIFadd{into a cognitive space }\DIFaddend to influence beliefs. Doing so is a necessary
...
\DIFdelbegin \DIFdel{the emotional contentof the graph}\DIFdelend \DIFaddbegin \DIFadd{emotional content}\DIFaddend , the consensus on how related the variables in
question were, and the general design (bar the points themselves) of the
scatterplot, we can conclude with strong evidence that \DIFdelbegin \DIFdel{atypical
}\DIFdelend \DIFaddbegin \DIFadd{alternative
}\DIFaddend scatterplot design was responsible for increasing the level of belief
change amongst participants.

\DIFaddbegin \DIFadd{An alternative (although not competing) explanation for the results we
have seen here comes from recent work on the incorporation of
uncertainty visualisations in scatterplots. Karduni et al.
\mbox{%DIFAUXCMD
\citep{karduni_2020} }\hskip0pt%DIFAUXCMD
found in 2020 that visualizations that encode
...
method developed by Karduni et al. \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citep{karduni_2021, karduni_2023}}\hskip0pt%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citep{karduni_2020, karduni_2023}}\hskip0pt%DIFAUXCMD
}\DIFaddend .
...
\DIFdelbegin %DIFDELCMD < \bibliography{atypical-scatterplots.bib}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \bibliography{alternative-scatterplots.bib}
\DIFaddend 
