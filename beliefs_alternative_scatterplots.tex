...
Table~\ref{tbl-rating-time}. \textbf{?@fig-descriptives} shows means and
violin plots for ratings of strength of relatedness before and after
...
\caption{\label{fig-descriptives-1}Dot plots for pre- and post-plot
...
\includegraphics[width=1\textwidth,height=\textheight]{beliefs_alternative_scatterplots_files/figure-pdf/fig-descriptives-2.pdf}

}

\caption{\label{fig-descriptives-2}Dot plots for pre- and post-plot
viewing ratings of strength of relatedness for standard and alternative
scatterplot conditions. Mean ratings are also shown as points.}
