...
{[}\citet{strain_2023}; \citet{strain_2023b}; strain\_2024{]}. Data were
...
(73 male, 73 female, and 4 non-binary). Participants' mean age was 39.3
(\emph{SD} = 11.5). Participants' mean graph literacy score was 21.3
(\emph{SD} = 4.3) out of 30, their mean defensive confidence score was
43 (\emph{SD} = 6.8) out of 60, and their mean rating of statement
emotional valence was 2.9 (\emph{SD} = 1.3) on a 7-point Likert scale.
...
Figure~\ref{fig-difference-descriptive}; the difference betweeen in
ratings between pre- and post-plot viewing times is greater for the
participants who were exposed to the alternaive scatterplot condition.
