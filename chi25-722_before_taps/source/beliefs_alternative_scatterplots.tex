...
received support from recent work exploiting visual features to facilitate more accurate correlation estimation in positively correlated scatterplots. Strain et al.
...
\centering{
\includegraphics[width=1\textwidth]{beliefs_alternative_scatterplots_files/figure-pdf/fig-previous-manipulations-1.pdf}
...
line hypothetically represents accurate estimation, while the solid line is
...
recruitment of samples from across our lay population of interest, and is considerably quicker and less expensive than in-person testing.
...
answers to the Likert scale sliders. No participants failed more than 2 out of 6 attention check
...
identical to those used by the authors in
...
3 and 5 are statements 2, 10, 16, 22, and 23, which can be seen in
...
risk) are positively correlated. While the manipulations we use in
...
\includegraphics[width=1\textwidth]{beliefs_alternative_scatterplots_files/figure-pdf/fig-main-examples-1.pdf}
...
assigned to either group A, in which they viewed standard
...
automate selection of the random effects structure; on provision of a maximal
model including random intercepts for participants, 
\textbf{buildmer} identifies the most complex model that successfully
converges. We also present odds ratios and equivalent Cohen's \emph{d} effect
...
\includegraphics[width=1\textwidth]{beliefs_alternative_scatterplots_files/figure-pdf/fig-descriptives-1.pdf}
...
\centering{\includegraphics{beliefs_alternative_scatterplots_files/figure-pdf/fig-difference-descriptive-1.pdf}
...
of strength of relatedness for standard and alternative scatterplots. Median values are plotted as points.}
...
Emotional Valence}\label{sec-add-analyses-discussion}
...
emotional valence (right). Locally smoothed curves with 95\% CI ribbons are
...
the emotional valence of the correlative statement have on the propensity for
...
\bibliography{alternative-scatterplots}
